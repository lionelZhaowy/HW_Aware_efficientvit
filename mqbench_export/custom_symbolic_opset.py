...
def _fake_quantize_learnable_per_tensor_affine(
    ...
    # modify by zwy
    def get_jit_scalar_type(value):
        if isinstance(value, float):
            return _type_utils.JitScalarType.FLOAT
        elif isinstance(value, int):
            return _type_utils.JitScalarType.INT
        else:
            return _type_utils.JitScalarType.UNDEFINED
    ...
    if quant_min == 0:
        ...
        zero_point = g.op("Cast", zero_point, to_i=_C_onnx.TensorProtoDataType.INT8)
    # modify by zwy
    if get_jit_scalar_type(scale) != _type_utils.JitScalarType.FLOAT:
    # if (
    #     _type_utils.JitScalarType.from_value(scale, _type_utils.JitScalarType.UNDEFINED)
    #     != _type_utils.JitScalarType.FLOAT
    # ):
