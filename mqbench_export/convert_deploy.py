...
import mqbench_export.custom_symbolic_opset  # noqa: F401
import mqbench_export.fusion_method          # noqa: F401
from mqbench_export.prepare_by_platform import BackendType
from mqbench_export.utils import deepcopy_graphmodule
from mqbench_export.utils.logger import logger
from mqbench_export.utils.registry import (
    BACKEND_DEPLOY_FUNCTION,
    register_deploy_function,
    FUSED_MODULE_CONVERT_FUNCTION
)
from mqbench_export.deploy import (
...
from mqbench_export.deploy.common import (
    parse_attrs
)
...
def convert_onnx(model: GraphModule, input_shape_dict, dummy_input, onnx_model_path, **kwargs):
    ...
    # opset_version = 17 if kwargs.get('deploy_to_qlinear', False) else 13
    opset_version = 17
    with torch.no_grad():
...
def  convert_deploy(model: GraphModule, backend_type: BackendType,
                   ...
                   model_name='mqbench_export_qmodel', deploy_to_qlinear=False, **extra_kwargs):
    ...
    Args:
        ...
        model_name (str, optional): name of converted onnx model. Defaults to 'mqbench_export_qmodel'.
