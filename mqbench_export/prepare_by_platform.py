...
from mqbench_export.fuser_method_mappings import _get_custom_conv_configs

from mqbench_export.fake_quantize import (
...
from mqbench_export.observer import (
    ClipStdObserver,
    LSQObserver,
    MinMaxFloorObserver,
    MinMaxObserver,
...
# from mqbench_export.fuser_method_mappings import fuse_custom_config_dict
from mqbench_export.utils.logger import logger
from mqbench_export.utils.registry import DEFAULT_MODEL_QUANTIZER
...
def prepare_by_platform(
    ...
    # Prepare
    import mqbench_export.custom_quantizer  # noqa: F401
